...
AWS_SECRET_ACCESS_KEY = (
    os.environ.get("SECRET_ACCESS_KEY") or "zGAwPQbY84lZnKb+BVgORPc/DCI3TkNrz4grsNtH"
)
AWS_REGION_NAME = os.environ.get("AWS_REGION_NAME") or "ap-northeast-2"

# SQS
SQS_BASE = (
    os.environ.get("SQS_BASE")
    or "https://sqs.ap-northeast-2.amazonaws.com/208389685150"
)
...
SLACK_TOKEN = (
    ...
    or "xoxb-1811487173312-2075478573287-JtTJbgy3fAboqlwkLeas9R1o"
)
